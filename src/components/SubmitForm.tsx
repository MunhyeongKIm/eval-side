    ...
    <form onSubmit={handleSubmit} aria-label="Submit new project" className="space-y-4 bg-gray-900 rounded-xl p-6 border border-gray-800">
      ...
      <div>
        ...
        <textarea
          ...
          rows={3}
          maxLength={2000}
          className="w-full px-3 py-2.5 bg-gray-800/50 border border-gray-700/50 rounded-lg text-white placeholder-gray-600 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/20 transition-all resize-none text-sm"
      ...
      <button
        ...
        className="w-full py-2.5 bg-blue-600 hover:bg-blue-500 disabled:bg-gray-800 disabled:text-gray-600 text-white font-medium rounded-lg transition-all text-sm flex items-center justify-center gap-2"
      >
        {loading ? (
          <>
      ...
      <p className="text-[10px] text-gray-600 text-center">
        Free tier: up to 100 evaluations per day
      </p>
    </form>
  );
}
